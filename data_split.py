...
#    train_set_2,train_set_2_target = filterByUserid(train_set_2,train_set_2_target)
    ...
    train_set_2_features.to_csv('train_set_2_features_'+train_startDatetime+'_'+str(train_EndDatetime)+'.csv')
    train_set_2_target.to_csv('train_set_2_target_'+train_startDatetime+'_'+str(train_EndDatetime)+'.csv')
...
#    test_set_2,test_set_2_target = filterByUserid(test_set_2,test_set_2_target)
    ...
    test_set_2_features.to_csv('test_set_2_features_'+test_StartDatetime+'_'+str(test_EndDatetime)+'.csv')
    test_set_2_target.to_csv('test_set_2_target_'+test_StartDatetime+'_'+str(test_EndDatetime)+'.csv')
